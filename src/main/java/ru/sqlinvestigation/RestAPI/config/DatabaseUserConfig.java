...
@EnableJpaRepositories(
        entityManagerFactoryRef = DatabaseUserConfig.ENTITY_MANAGER_FACTORY,
        transactionManagerRef = DatabaseUserConfig.TRANSACTION_MANAGER,
        basePackages = DatabaseUserConfig.JPA_REPOSITORY_PACKAGE
)
@Configuration
public class DatabaseUserConfig {

    public static final String PROPERTY_PREFIX = "user.datasource";
    public static final String JPA_REPOSITORY_PACKAGE = "ru.sqlinvestigation.RestAPI.repositories.userDB";
    public static final String ENTITY_PACKAGE = "ru.sqlinvestigation.RestAPI.models.userDB";
    public static final String ENTITY_MANAGER_FACTORY = "userEntityManagerFactory";
    public static final String DATA_SOURCE = "userDataSource";
    public static final String DATABASE_PROPERTY = "userDatabaseProperty";
